...
global.AccountSchema = require('./api/models/AccountSchema');
global.UserSchema = require('./api/models/UserSchema');
global.LogRefSchema = require('./api/models/LogRefSchema');
global.LogSignInSchema = require('./api/models/LogSignInSchema');
...
app.use((req, res) => {
  ...
  //   return res.status(401).json({ msg: "Unauthorzide" });
  // }
